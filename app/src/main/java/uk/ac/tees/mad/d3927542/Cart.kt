...
fun Cart(
    ...
    Column(
        ...
        if (dataViewModel.cartData.value.isEmpty())
            ...
            getRow("Subtotal", "Rs. $subtotal")
            getRow(dataLeft = "Shipping Cost (10%)", dataRight = "Rs. ${(subtotal.toDouble()  / 0.1)/100}")
            getRow(dataLeft = "Tax", dataRight = "Rs. 0.0")
            getRow(dataLeft = "Total", dataRight = "Rs. ${subtotal + ((subtotal.toDouble()  / 0.1)/100)}")
            Spacer(modifier = Modifier.height(16.dp))
        ...
        Row (
            ...
            Column(
                ...
                Row(Modifier.fillMaxWidth(),
                    ...
                    Text(text = "Rs. ${cartData.price}.00",
