...
fun ProductDetail(
    ...
    Column (
                ...
                .verticalScroll(rememberScrollState()))
        {
            ...
            Text("Rs. ${product.price}.00", fontWeight = FontWeight.Bold, fontSize = 18.sp, modifier = Modifier.padding(4.dp), color = Color.Black)
        ...
        OutlinedButton(
            ...
            Row (
                ...
                verticalAlignment = Alignment.CenterVertically,
                horizontalArrangement = Arrangement.SpaceBetween){
                Text(text = "Rs. ${product.price}.00", fontWeight = FontWeight.Bold, color = Color.White, fontSize = 18.sp, modifier = Modifier.padding(4.dp))
